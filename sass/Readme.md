...
folder are mapped to the application's root namespace, 'extTestTs'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'extTestTs' in the same way
as `"extTestTs/sass/src"`.
